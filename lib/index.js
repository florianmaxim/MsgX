...
app.get('*', function (req, res) {
  io.on('connection', function (socket) {
    ...
    io.sockets.emit('author', message.author); //console.log('Websocket: connected.');
  ...
  if (context.url) {
    ...
    res.write("<!doctype html><html><head><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0, user-scalable=no\"><meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"><link rel=\"shortcut icon\" type=\"image/x-icon\" href=\"/static/favicon.png\"><title>".concat(config.info.slogan, "</title>").concat(styles, "</head><body><div id=\"root\">").concat(html, "</div><script src=\"/bundle.js\"></script></body></html>"));
    res.end();
  }
});
